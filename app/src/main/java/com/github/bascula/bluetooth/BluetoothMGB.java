...
package com.github.bascula.bluetooth;
...
public class BluetoothMGB extends BluetoothCommunication {
    ...
    protected boolean onNextStep(int stepNr) {
        switch (stepNr) {
            ...
            case 3:
                writeCfg(0xFB, (user.isMale() ? 1 : 2), user.getAge(), (int)user.getBodyHeightInCentimeters());
                break;
            ...
            case 6:
                writeCfg(0xFE, 6, user.returnZeroIfMetersOneIfPoundsTwoIfStones(), 0);
                break;

            case 7:
//                sendMessage("step on scale", 0);
                break;
